...
namespace MinimalAPIPeliculas.Endpoints
{
    public static class PeliculasEndPoints
    {
        ...
        static async Task<Ok<List<PeliculaDTO>>> Obtener(IRepositorioPeliculas repositorio, IMapper mapper, int pagina=1, int recordsPorPagina = 10)
        {
        ...
        static async Task<Results<Ok<PeliculaDTO>,NotFound>> ObtenerPorId(int id, IRepositorioPeliculas repositorio, IMapper mapper)
        {
            ...
            if (pelicula is null) return TypedResults.NotFound();
            ...
            IAlmacenadorArchivos almacenadorArchivos, IOutputCacheStore outputCacheStore, IMapper mapper)
        {
            ...
            if (peliculaDB is null) return TypedResults.NotFound();
        ...
        static async Task<Results<NoContent, NotFound>> Borrar(int id,IRepositorioPeliculas repositorio, IAlmacenadorArchivos almacenadorArchivos, 
            ...
            IRepositorioGeneros repositorioGeneros)
        {
            ...
            if (generosIds.Count != 0) generosExistentes = await repositorioGeneros.Existen(generosIds);
            ...
            IRepositorioPeliculas repositorioPeliculas, IRepositorioActores repositorioActores, IMapper mapper)
        {
            ...
            if (actoresDTO.Count != 0) actoresExistentes = await repositorioActores.Existen(actoresIds);
