...
namespace MinimalAPIPeliculas.Endpoints
{
    public static class UsuariosEndpoints
    {
        public static RouteGroupBuilder MapUsuarios(this RouteGroupBuilder group)
        {
            ...
            group.MapPost("/haceradmin", HacerAdmin).AddEndpointFilter<FiltroValidaciones<CredencialesUsuarioDTO>>()
                .RequireAuthorization("esadmin");
            group.MapPost("/removeradmin", RemoverAdmin).AddEndpointFilter<FiltroValidaciones<CredencialesUsuarioDTO>>()
                .RequireAuthorization("esadmin");
            return group;
        }
            ...
            [FromServices] UserManager<IdentityUser> userManager, IConfiguration configuration)
        {
            ...
            else return TypedResults.BadRequest(resultado.Errors);
        }
            ...
            [FromServices] SignInManager<IdentityUser> signInManager, [FromServices] UserManager<IdentityUser> userManager, IConfiguration configuration)
        {
            ...
            if (usuario is null) return TypedResults.BadRequest("Login incorrecto");
            ...
            }else return TypedResults.BadRequest("Login incorrecto");
        }
        ...
        private static async Task<RespuestaAutenticacionDTO> ConstruirToken(CredencialesUsuarioDTO credencialesUsuarioDTO, IConfiguration configuration, 
