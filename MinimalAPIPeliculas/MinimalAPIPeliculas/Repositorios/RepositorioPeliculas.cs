...
namespace MinimalAPIPeliculas.Repositorios
{
    public class RepositorioPeliculas : IRepositorioPeliculas
    {
        ...
        public async Task AsignarGeneros(int id,List<int> generosIds)
        {
            ...
            if (pelicula is null) throw new ArgumentException($"No existe una película con el id {id}");
        ...
        public async Task<List<Pelicula>> Filtrar(PeliculasFiltrarDTO peliculasFiltrarDTO)
        {
            ...
            if (peliculasFiltrarDTO.EnCines) peliculasQueryable = peliculasQueryable.Where(p => p.EnCines);
            ...
            {
                peliculasQueryable = peliculasQueryable.Where(p => p.GenerosPeliculas.Select(gp => gp.GeneroId).Contains(peliculasFiltrarDTO.GeneroId));
            }
